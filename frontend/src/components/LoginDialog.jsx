...
const LoginDialog = ({ open, onClose, onLogin, onRegister, showSnackbar }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isLogin) {
        // Login
        const response = await fetch('https://test-tech-qfks.onrender.com/api/auth/login', {
          method: 'POST',
        ...
        // Register
        const response = await fetch('https://test-tech-qfks.onrender.com/api/auth/register', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
